...
class LXDDriver(driver.ComputeDriver):
    ...
    def rebuild(self, context, instance, image_meta, injected_files,
        ...
        return self.container_ops.rebuild(context, instance, image_meta, injected_files,
                admin_password, bdms, detach_block_devices,
                attach_block_devices, network_info,
                recreate, block_device_info,
                preserve_ephemeral)

    def list_instance_uuids(self):
        return self.container_ops.list_instance_uuids()
    ...
    def attach_volume(self, context, connection_info, instance, mountpoint,
        ...
        self.container_ops.attach_volume(context, connection_info, instance, mountpoint,
                                         disk_bus=None, device_type=None, encryption=None)

    def detach_volume(self, connection_info, instance, mountpoint,
                      encryption=None):
        self.container_ops.detach_volume(connection_info, instance, mountpoint,
                                         encryption=None)
